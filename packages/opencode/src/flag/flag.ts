...
export const Flag = {
  ...
  OPENCODE_DISABLE_NPM_PLUGINS: truthy("OPENCODE_DISABLE_NPM_PLUGINS"),
  OPENCODE_DISABLE_PLUGIN_DEP_INSTALL: truthy("OPENCODE_DISABLE_PLUGIN_DEP_INSTALL"),
  OPENCODE_ALLOWED_FILE_PLUGINS: process.env["OPENCODE_ALLOWED_FILE_PLUGINS"],
